...
public class MockedDeviceServiceTest {
    ...
    @Test
    @DisplayName("should be able to get a device's data")
    void getDeviceData() {
    ...
    @Test
    @DisplayName("should be able to save a device")
    void saveDeviceData() {
    ...
    @Test
    @DisplayName("should be able to delete a device")
